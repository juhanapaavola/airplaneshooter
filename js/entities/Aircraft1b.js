game.Aircraft1bEntity = me.ObjectEntity.extend({
	canFire: true,
	fireRate: 1300,
   ...
   init: function(x, y, settings) {
        ...
        this.gravity = 0;
        this.type = game.types.AIRCRAFT_1B;
	...
	update:function(){
		...
		if(this.canFire && game.debug.enemyShoot){
			var bullet = me.entityPool.newInstanceOf("enemyBullet",this.pos.x+27,this.pos.y+59,{image:'bullet_single',spritewidth:18,vel:this.vel.y+6});
			var that = this;
